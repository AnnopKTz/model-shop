	...
	render() {
		...
		return (
			<div className="Registration">
				<h1>
					WELCOME TO PARA STORE MODEL SHOPING
				</h1>
				...
				{/* <form onSubmit={this.onSubmit}>
					<div>
						<div className="fields">
							...
							<input type="text" value={this.state.firstName} name="FirstName" onChange={this.handleOnChangeFirstName}/>
						</div>
						<div className="fields">
								<p>{ REGISTRATION_FIELDS.LAST_NAME }</p>
								<input type="text" value={this.state.lastName} name="LastName" onChange={this.handleOnChangeLastName}/>
						</div>
						<div className="fields">
								<p>{ REGISTRATION_FIELDS.EMAIL_NAME }</p>
								<input type="text" value={this.state.email} name="email" onChange={this.handleOnChangeEmail}/>
						</div>
						<div className="fields">
								<p>{ REGISTRATION_FIELDS.JOBTITLE_NAME }</p>
								<input type="text" value={this.state.jobTitle} name="jobTitle" onChange={this.handleOnChangeJobTitle}/>
						</div>
						<div className="fields">
